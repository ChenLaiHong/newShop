    ...
    <div class="slideall" style="height: auto;">
        ...
        <div class="bannerTwo">
            ...
            <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
                <ul class="am-slides">
                    <li class="banner1"><a href="introduction.html"><img src="${pageContext.request.contextPath}/static/images/ad5.jpg" /></a></li>
                        ...
                        <ul class="category-list navTwo" id="js_climit_li">
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
                                    <em>&gt;</em></div>
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/static/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
        ...
        <!--各类活动-->
        <div class="row">
            <li><a><img src="${pageContext.request.contextPath}/static/images/row1.jpg"/></a></li>
            <li><a><img src="${pageContext.request.contextPath}/static/images/row2.jpg"/></a></li>
            <li><a><img src="${pageContext.request.contextPath}/static/images/row3.jpg"/></a></li>
            <li><a><img src="${pageContext.request.contextPath}/static/images/row4.jpg"/></a></li>
        </div>
        <div class="clear"></div>
        <!--走马灯 -->
            ...
            <div class="demo">
                ...
                <ul>
                    <li class="title-first"><a target="_blank" href="#">
                        <img src="${pageContext.request.contextPath}/static/images/TJ2.jpg">
        ...
        <div class="am-container">
            ...
            <div class="am-g am-g-fixed sale">
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/sale3.jpg" /></a>
                    </div>
                    <div class="s-info">
                ...
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/sale2.jpg" /></a>
                    </div>
                    <div class="s-info">
                        <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                        <div class="s-price">￥<b>9.90</b>
                ...
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/sale1.jpg" /></a>
                    </div>
                    <div class="s-info">
                        <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                        <div class="s-price">￥<b>9.90</b>
        ...
        <div class="f1">
            ...
            <div class="am-g am-g-fixed floodSix ">
                ...
                <div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
                    ...
                    <a href="# "><img src="${pageContext.request.contextPath}/static/images/act1.png" /></a>
                </div>
            ...
            <div class="am-g am-g-fixed floodSeven">
                ...
                <li>
                    <div class="am-u-sm-7 am-u-md-4 text-two">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/6.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three sug">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/7.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three big">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/10.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three ">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/8.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three ">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/static/images/9.jpg" /></a>
                    </div>
                </li>
            </div>
            <div class="clear "></div>
...
<script type="text/javascript " src="${pageContext.request.contextPath}/static/basic/js/jquery.min.js "></script>
