            ...
            <div class="am-container header">
                ...
                <ul class="message-r">
                    ...
                    <div class="topMessage my-shangcheng">
                        <div class="menu-hd MyShangcheng"><a href="${pageContext.request.contextPath}/personIndex.jsp" target="_top"><i
                ...
                <div class="wrap-list">
                    <div class="m-user">
                        ...
                        <div class="m-userinfo">
                            ...
                            <div class="m-baseinfo">
                                <a class="m-pic" href="${pageContext.request.contextPath}/personInformation.jsp">
                    ...
                    <div class="m-order">
                        ...
                        <ul>
                            <li><a href="order.html"><i><img
                                    src="${pageContext.request.contextPath}/static/images/pay.png"/></i><span>待付款</span></a>
                            </li>
                            <li><a href="order.html"><i><img
                                    src="${pageContext.request.contextPath}/static/images/send.png"/></i><span>待发货<em
                                    class="m-num">1</em></span></a></li>
                            <li><a href="order.html"><i><img
                                    src="${pageContext.request.contextPath}/static/images/receive.png"/></i><span>待收货</span></a>
                            </li>
                            <li><a href="order.html"><i><img
                                    src="${pageContext.request.contextPath}/static/images/comment.png"/></i><span>待评价<em
                                    class="m-num">3</em></span></a></li>
                            <li><a href="change.jsp"><i><img
                                    src="${pageContext.request.contextPath}/static/images/refund.png"/></i><span>退换货</span></a>
                            </li>
                        </ul>
                                ...
                                <div class="orderContentpic">
                                    <div class="imgBox">
                                        <a href="orderinfo.html"><img
                                                src="${pageContext.request.contextPath}/static/images/youzi.jpg"></a>
                                    </div>
                                </div>
                        ...
                        <div class="orderContentBox">
                            <div class="orderContent">
                                <div class="orderContentpic">
                                    <div class="imgBox">
                                        <a href="orderinfo.html"><img
                                                src="${pageContext.request.contextPath}/static/images/heart.jpg"></a>
                                    </div>
                                </div>
                                <div class="detailContent">
                    ...
                    <div class="user-squaredIcon">
                        ...
                        <ul>
                            ...
                            <a href="${pageContext.request.contextPath}/static/home/home2.html">
                        ...
                        <div class="twoTabModel credit">
                            ...
                            <div class="Box">
                                ...
                                <div class="am-slider am-slider-default am-slider-carousel"
                                    ...
                                    <ul class="am-slides">
                                        <li><a href="#"><img
                                                src="${pageContext.request.contextPath}/static/images/333.jpg"/></a>
                                        </li>
                                        <li><a href="#"><img
                                                src="${pageContext.request.contextPath}/static/images/222.jpg"/></a>
                                        </li>
                                        <li><a href="#"><img
                                                src="${pageContext.request.contextPath}/static/images/111.jpg"/></a>
                                        </li>
                                        <li><a href="#"><img
                                                src="${pageContext.request.contextPath}/static/images/333.jpg"/></a>
                                        </li>
                    ...
                    <div class="new-goods-info">
                        <a class="shop-info" href="#">
                            <div class="face-img-panel">
                                <img src="${pageContext.request.contextPath}/static/images/imgsearch1.jpg" alt="">
                            </div>
                ...
                <div class="new-goods">
                    ...
                    <div class="new-goods-info">
                        <a class="shop-info" href="#" target="_blank">
                            <div>
                                <img src="${pageContext.request.contextPath}/static/images/666.jpg" alt="">
                            </div>
                            ...
                            <ul class="am-slides">
                                <li>
                                    <a><img class="am-thumbnail"
                                            src="${pageContext.request.contextPath}/static/images/EZA27501.jpg"/></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail"
                                            src="${pageContext.request.contextPath}/static/images/BxJk6.jpg"/></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail"
                                            src="${pageContext.request.contextPath}/static/images/Hxcag60.jpg"/></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail"
...
<!--引导 -->
<div class="navCir">
    <li><a href="${pageContext.request.contextPath}/static/home/home2.jsp"><i class="am-icon-home "></i>首页</a></li>
    <li><a href="${pageContext.request.contextPath}/static/home/sort.jsp"><i class="am-icon-list"></i>分类</a></li>
    <li><a href="${pageContext.request.contextPath}/static/home/shopcart.jsp"><i class="am-icon-shopping-basket"></i>购物车</a>
    </li>
