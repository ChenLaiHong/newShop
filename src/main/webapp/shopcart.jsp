...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/optstyle.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="bundle  bundle-last ">
                ...
                <div class="bundle-main">
                    ...
                    <ul class="item-content clearfix">
                        <li class="td td-chk">
                            <div class="cart-checkbox ">
                                <input class="check" id="J_CheckBox_17003795025" name="items[]" value="170037950254"
                                       type="checkbox">
                                <label for="J_CheckBox_17003795025"></label>
                            </div>
                        </li>
                        <li class="td td-item">
                            <div class="item-pic">
