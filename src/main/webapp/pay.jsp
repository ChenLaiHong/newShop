                ...
                <li class="user-addresslist defaultAddr">
                   ...
                   <span class="buy-user">艾迪 </span>
                    ...
                    <div class="address-right">
                        <a href="${pageContext.request.contextPath}/static/person/address.html">
        ...
        <div class="logistics">
            ...
            <ul class="pay-list">
                <li class="pay card"><img
                        src="${pageContext.request.contextPath}/static/images/wangyin.jpg"/>银联<span></span></li>
                <li class="pay qq"><img
                        src="${pageContext.request.contextPath}/static/images/weizhifu.jpg"/>微信<span></span></li>
                <li class="pay taobao"><img
                        src="${pageContext.request.contextPath}/static/images/zhifubao.jpg"/>支付宝<span></span></li>
            </ul>
        </div>
        <div class="clear"></div>
