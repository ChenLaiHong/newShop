...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/cpstyle.css" rel="stylesheet" type="text/css">
                                    ...
                                    <div class="coupon-list">
                                        ...
                                        <li class="td td-usestatus ">
                                            <div class="item-usestatus ">
                                                <span><img src="${pageContext.request.contextPath}/static/images/gift_stamp_31.png"></span>
                                            </div>
                                        </li>
                                    </div>
                                </div>
                                <div class="coupon-item coupon-item-yf">
                                    <div class="coupon-list">
                                        ...
                                        <li class="td td-usestatus ">
                                            <div class="item-usestatus ">
                                                <span><img
                                                        src="${pageContext.request.contextPath}/static/images/gift_stamp_21.png"</span>
                                            </div>
                                        </li>
                                    </div>
                                </div>
