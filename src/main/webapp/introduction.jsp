        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="${pageContext.request.contextPath}/static/images/01.jpg"><img
                            src="${pageContext.request.contextPath}/static/images/01_mid.jpg" alt="细节展示放大镜特效"
                            rel="${pageContext.request.contextPath}/static/images/01.jpg"
                            class="jqzoom"/></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/images/01_small.jpg"
                                             mid="${pageContext.request.contextPath}/static/images/01_mid.jpg"
                                             big="${pageContext.request.contextPath}/static/images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/images/02_small.jpg"
                                             mid="${pageContext.request.contextPath}/static/images/02_mid.jpg"
                                             big="${pageContext.request.contextPath}/static/images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/images/03_small.jpg"
                                             mid="${pageContext.request.contextPath}/static/images/03_mid.jpg"
                                             big="${pageContext.request.contextPath}/static/images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
...
<div class="match">
    ...
    <div class="match-comment">
        <ul class="like_list">
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="${pageContext.request.contextPath}/static/images/cp.jpg"></a>
                </div>
            ...
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="${pageContext.request.contextPath}/static/images/cp2.jpg"></a>
                </div>
    ...
    <div class="browse">
        <div class="mc">
            <ul>
                ...
                <li class="first">
                    <div class="p-img">
                        <a href="#"> <img class="" src="${pageContext.request.contextPath}/static/images/browse1.jpg">
                        </a>
                    </div>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            <img src="${pageContext.request.contextPath}/static/images/tw1.jpg"/>
                            <img src="${pageContext.request.contextPath}/static/images/tw2.jpg"/>
                            <img src="${pageContext.request.contextPath}/static/images/tw3.jpg"/>
                            <img src="${pageContext.request.contextPath}/static/images/tw4.jpg"/>
                            <img src="${pageContext.request.contextPath}/static/images/tw5.jpg"/>
                        </div>
                    </div>
                    <div class="clear"></div>
                        ...
                        <li class="am-comment">
                            ...
                            <a href="">
                                <img class="am-comment-avatar"
                                     src="${pageContext.request.contextPath}/static/images/hwbn40x40.jpg"/>
                                <!-- 评论者头像 -->
                            </a>
                        ...
                        <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                            <li>
                                <div class="i-pic limit">
                                    <img src="${pageContext.request.contextPath}/static/images/imgsearch1.jpg"/>
    ...
    <div id="sidebar">
        <div id="wrap">
                ...
                <div class="ibar_login_box status_login">
                    <div class="avatar_box">
                        <p class="avatar_imgbox"><img
                                src="${pageContext.request.contextPath}/static/images/no-img_mid_.jpg"/></p>
                        <ul class="user_info">
                            <li>用户名：sl1903</li>
                            <li>级&nbsp;别：普通会员</li>
                        </ul>
            ...
            <div id="broadcast" class="item">
                <a href="#">
                    <span class="chongzhi"><img
                            src="${pageContext.request.contextPath}/static/images/chongzhi.png"/></span>
                </a>
                <div class="mp_tooltip">
                    我要充值
                    <i class="icon_arrow_right_black"></i>
            ...
            <div class="quick_toggle">
                ...
                <li class="qtitem">
                    ...
                    <div class="mp_qrcode" style="display:none;"><img
                            src="${pageContext.request.contextPath}/static/images/weixin_code_145.png"/><i
